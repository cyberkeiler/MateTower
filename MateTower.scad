...
rotate([90,0,0])
Fuehrungsplatte3D( w=$Tower_width, h=$Tower_height, r=$mate_r1,d=$Barrel_distance,t=2, n=$Barrel_stages+3, off=$Barrel_offset);

//Führungsplatte vorne
translate([-$Tower_width/2,-19.1,0])
rotate([90,0,0])
Fuehrungsplatte3D( w=$Tower_width, h=$Tower_height, r=$mate_r2,d=$Barrel_distance,t=2,n=$Barrel_stages+3, off=$Barrel_offset);
